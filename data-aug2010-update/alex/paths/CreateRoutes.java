...
public static void main(String[] args) throws Exception	
{
    ...
    routes_arr[25].days = WEEKDAY;
    
    routes_arr[26].color = 0x6F3996;
    routes_arr[26].days = WEEKDAY;
    
    routes_arr[27].color = 0x7EC2D1;
    routes_arr[27].days = WEEKDAY;
    
    routes_arr[28].color = 0x00BAD3;
	routes_arr[29].days = WEEKDAY;
	...
	routes_arr[52].days = WEEKDAY;
	
    routes_arr[55].color = 0xD8BD5B;
    routes_arr[55].days = WEEKDAY;
    
    routes_arr[56].color = 0x977B6D;
    routes_arr[56].days = WEEKDAY;
    
    routes_arr[57].color = 0x87733B;
    routes_arr[57].days = WEEKDAY;
    
    routes_arr[58].color = 0xA2A399;
	routes_arr[58].days = WEEKDAY;
	
	routes_arr[59].color = 0xF49BC2;
    routes_arr[59].days = HOLIDAY;
    
    routes_arr[63].color = 0xEB9E18;
    routes_arr[63].days = HOLIDAY;
	
	routes_arr[67].color = 0x5186A7;
	routes_arr[67].days = BOTH;
	
	routes_arr[68].color = 0x00AB4F;
    routes_arr[68].days = HOLIDAY;
	
	routes_arr[70].color = 0xA6B4DC;
    routes_arr[70].days = WEEKDAY;
	
	routes_arr[71].color = 0xB88073;
    routes_arr[71].days = WEEKDAY;
	
	routes_arr[72].color = 0x9A061A;
    routes_arr[72].days = WEEKDAY;
	
	routes_arr[73].color = 0xEFB60F;
    routes_arr[73].days = WEEKDAY;
    
    routes_arr[74].color = 0xCD5C2C;
    routes_arr[74].days = WEEKDAY;
    
    routes_arr[78].color = 0x005CAB;
    routes_arr[78].days = HOLIDAY; // Saturday only
    ...
    routes_arr[92].days = WEEKDAY;
    
	routes_arr[90].color = 0x0172bc;
    routes_arr[90].days = WEEKDAY;
    
	routes_arr[91].color = 0x93268f;
    routes_arr[91].days = WEEKDAY;
    
	routes_arr[93].color = 0xe93724;
    routes_arr[93].days = WEEKDAY;
